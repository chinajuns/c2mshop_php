...
interface IShop
{
     ...
     */
    function updateShopConfigByPlatform($shop_id, $shop_name, $shop_group_id, $shop_platform_commission_rate, $shop_type, $shop_credit, $shop_desccredit, $shop_servicecredit, $shop_deliverycredit, $store_qtian, $shop_zhping, $shop_erxiaoshi, $shop_tuihuo, $shop_shiyong, $shop_shiti, $shop_xiaoxie, $shop_huodaofk, $shop_state, $shop_close_info);
     ...
     * @param unknown $shop_id            
     */
    function updateShopShareCinfig($shop_id, $goods_param_1, $goods_param_2, $shop_param_1, $shop_param_2, $shop_param_3, $qrcode_param_1, $qrcode_param_2,$platform_param_1,$platform_param_2,$platform_param_3);
