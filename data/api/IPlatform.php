...
interface IPlatform
{
     ...
     */
    function addPlatformAdvPosition($instance_id, $ap_name, $ap_intro, $ap_class, $ap_display, $is_use, $ap_height, $ap_width, $default_content, $ap_background_color, $type);
    /**
     * 修改广告位
     * @param unknown $ap_id
     * @param unknown $ap_name
     ...
     * @param unknown $default_content
     */
    function updatePlatformAdvPosition($ap_id, $instance_id, $ap_name, $ap_intro, $ap_class, $ap_display, $is_use, $ap_height, $ap_width, $default_content, $ap_background_color, $type);
    /**
     * 获取平台广告列表
     * @param unknown $page_index
     * @param number $page_size
     ...
     * 获取平台促销板块信息
     */
    function getPlatformGoodsRecommendClass();
    /**
     * 添加促销板块
     * @param unknown $class_name
     * @param unknown $sort
