...
class System extends BaseController
{
    ...
    public function addShopAdvPosition()
    {
        if (request()->isAjax()) {
            ...
            $platform = new Platform();
            $res = $platform->addPlatformAdvPosition($this->instance_id, $ap_name, $ap_intro, $ap_class, $ap_dis, $is_use, $ap_height, $ap_width, $default_content, $ap_background_color, $type);
    ...
    public function updateShopAdvPosition()
    {
        ...
        if (request()->isAjax()) {
            ...
            $ap_background_color = request()->post('ap_background_color', '');
            $type = request()->post('type', '');
            $res = $platform->updatePlatformAdvPosition($ap_id, $this->instance_id, $ap_name, $ap_intro, $ap_class, $ap_dis, $is_use, $ap_height, $ap_width, $default_content, $ap_background_color, $type);
            return AjaxReturn($res);
        }
    ...
    public function goodsRecommendClass()
    {
       // $this->pcConfigChildMenuList(2);
        $platform = new Platform();
        $goods_recommend_class = $platform->getshopPlatformGoodsRecommendClass($this->instance_id);
    ...
    public function searchGoods()
    {
        ...
        $where['ng.shop_id'] = $this->instance_id;
        $goods = new Goods();
    ...
    public function updateGoodsRecommendClass()
    {
        ...
        $goods_id_array = request()->post('goods_id_str', '');
        $sort = request()->post('sort', '');
