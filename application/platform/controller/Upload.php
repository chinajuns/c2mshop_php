...
class Upload extends Controller
{
    ...
    public function photoCreate($upFilePath, $photoPath, $ext, $type = 0, $pic_name, $album_id, $width, $height, $pic_tag, $pic_id)
    {
        ...
        $album = new Album();
        if ($pic_id == "") {
            $retval = $album->addPicture($pic_name, $pic_tag, $album_id, iconv("gb2312", "UTF-8", $photoPath), $width . "," . $height, $width . "," . $height, iconv("gb2312", "UTF-8", $photoArray["bigPath"]["path"]), $photoArray["bigPath"]["width"] . "," . $photoArray["bigPath"]["height"], $photoArray["bigPath"]["width"] . "," . $photoArray["bigPath"]["height"], iconv("gb2312", "UTF-8", $photoArray["middlePath"]["path"]), $photoArray["middlePath"]["width"] . "," . $photoArray["middlePath"]["height"], $photoArray["middlePath"]["width"] . "," . $photoArray["middlePath"]["height"], iconv("gb2312", "UTF-8", $photoArray["smallPath"]["path"]), $photoArray["smallPath"]["width"] . "," . $photoArray["smallPath"]["height"], $photoArray["smallPath"]["width"] . "," . $photoArray["smallPath"]["height"], iconv("gb2312", "UTF-8", $photoArray["littlePath"]["path"]), $photoArray["littlePath"]["width"] . "," . $photoArray["littlePath"]["height"], $photoArray["littlePath"]["width"] . "," . $photoArray["littlePath"]["height"]);
        } else {
