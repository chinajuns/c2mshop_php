...
class Shop extends BaseController
{
    ...
    public function updateshop(){
        if(request()->isAjax()){
            ...
            $shop = new ShopService();
            $res = $shop->updateShopConfigByPlatform($shop_id, $shop_name, $shop_group_id, $shop_platform_commission_rate, $shop_type, $shop_credit, $shop_desccredit, $shop_servicecredit, $shop_deliverycredit, $store_qtian, $shop_zhping, $shop_erxiaoshi, $shop_tuihuo, $shop_shiyong, $shop_shiti, $shop_xiaoxie, $shop_huodaofk, $shop_state, $shop_close_info);
