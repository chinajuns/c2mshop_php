...
class Cms extends BaseController
{
    ...
    public function addArticleClass()
    {
        $article = new Article();
        $article_list = $article->getArticleClassQuery();
        $this->assign('article_class_frist_list', $article_list);
        return view($this->style . 'Cms/addArticleClass');
    }
    /**
     * 修改文章分类
     */
    public function updateArticleClass()
    {
        ...
        $article_class_info = $article->getArticleClassDetail($class_id);
        $this->assign('info',$article_class_info);
        return view($this->style . 'Cms/updateArticleClass');
    }
    /**
     * 根据文章id获取文章详情
     */
