...
class Express extends BaseController
{
    ...
    public function freightTemplateList()
    {
        if (request()->isAjax()) {
            ...
            if (! $co_id) {
                $this->redirect("express/expresscompany");
            }
            $this->assign("co_id", $co_id);
    ...
    public function freightTemplateEdit()
    {
        ...
        if (request()->isAjax()) {
            ...
            if ($shipping_fee_id) {
                $retval = $express->updateShippingFee($shipping_fee_id, $is_default, $shipping_fee_name, $province_id_array, $city_id_array, $weight_is_use, $weight_snum, $weight_sprice, $weight_xnum, $weight_xprice, $volume_is_use, $volume_snum, $volume_sprice, $volume_xnum, $volume_xprice, $bynum_is_use, $bynum_snum, $bynum_sprice, $bynum_xnum, $bynum_xprice);
            } else {
                $retval = $express->addShippingFee($co_id, $is_default, $shipping_fee_name, $province_id_array, $city_id_array, $weight_is_use, $weight_snum, $weight_sprice, $weight_xnum, $weight_xprice, $volume_is_use, $volume_snum, $volume_sprice, $volume_xnum, $volume_xprice, $bynum_is_use, $bynum_snum, $bynum_sprice, $bynum_xnum, $bynum_xprice);
            }
            return AjaxReturn($retval);
        } else {
            ...
            $existing_address_list = $express->getExpressCompanyProvincesAndCitiesById($co_id, $current_province_id_array, $current_city_id_array);
