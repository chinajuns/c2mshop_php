...
class Member extends BaseController
{
    ...
    public function shopCollectionList()
    {
        ...
        $member_detail = $this->user->getMemberDetail(0);
    ...
    public function orderInfo()
    {
        ...
        if (! empty($address)) {
            ...
            $express_company_list = $goods_express_service->getExpressCompany($shop_id, $goods_sku_list, $address['province'], $address['city'], $address['district']);
        ...
        $count = $goods_express_service->getExpressCompanyCount($shop_id);
