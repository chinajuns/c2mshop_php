<?php if (!defined('THINK_PATH')) exit(); /*a:13:{s:37:"template/wap/default/Index/index.html";i:1520605045;s:30:"template/wap/default/base.html";i:1520580411;s:34:"template/wap/default/urlModel.html";i:1520231681;s:31:"template/wap/default/share.html";i:1513303784;s:45:"template/wap/default/Index/controlSearch.html";i:1513303784;s:44:"template/wap/default/Index/controlSlide.html";i:1513303784;s:45:"template/wap/default/Index/controlNotice.html";i:1513303784;s:42:"template/wap/default/Index/controlNav.html";i:1513303784;s:45:"template/wap/default/Index/controlCoupon.html";i:1513303784;s:47:"template/wap/default/Index/controlDiscount.html";i:1513303784;s:37:"template/wap/default/Index/store.html";i:1520605167;s:32:"template/wap/default/footer.html";i:1520580272;s:39:"template/wap/default/shareContents.html";i:1513303784;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<?php endforeach; endif; else: echo "" ;endif; ?> -->
  ...
  .Rating-actived_GBtiHkB_0 svg, .Rating-gray_1kpffd5_0 svg {
    width: 1.493333rem;
    width: 14.933333vw;
    height: 1.266667rem;
    height: 3.666667vw;
...
<script type="text/javascript">
    $(function() {
      //根据地理位置匹配商家店铺
        $.ajax({
            type:"post",
            url : "<?php echo __URL('APP_MAIN/index/getstore'); ?>",
            data : {"district_id" : "0"},
            success : function(data){
                // alert(data.data.shop_id);
                var html='';
                if(data.data.length<0){
                    for(var i=0;i<data.data.length;i++){
                html +='<div id="shoplist-title" class="shoplist-title">推荐商家</div>\n' +
                    '          <section class="shoplist">\n' +
                                '<a href="APP_MAIN/shop/index?shop_id='+data.data[i].shop_id+'">\n'+
                    ...
                    '                    <img alt="'+data.data[i].shop_name+'" class="logo-logo_3S1eSkn_0" onerror="" src="__UPLOAD__'+data.data[i].shop_logo+'">\n' +
                    '                    <!---->\n' +
                    '                    <!---->\n' +
                    '                  </div>\n' +
                    '                  <!---->\n' +
                    ...
                    '                      <span>'+data.data[i].shop_name+'</span>\n' +
                    '                    </h3>\n' +
                    '                  </section>\n' +
                    '                  <section class="index-line_2-iYR1A">\n' +
                    '                    <div class="index-rateWrap_39dWx_g">\n' +
                    '\n' +
                    '                      <span class="index-rate_WsK58g8">4.5</span>\n' +
                    '                      <span>月售1000单</span>\n' +
                    '                    </div>\n' +
                    '                  </section>\n' +
                    '                  <section class="index-line_2-iYR1A">\n' +
                ...
                }else
                {
                    html +='<div style="text-align: center;">\n' +
                        '            <img src="__STATIC__/images/none.gif" style="width: 70%;" alt="">\n' +
                        '            <p style="color: #666;font-size: 18px;margin: 0;">附近没有商家店铺</p>\n' +
                        '            <p style="color: #666;">正在光速赶来</p>\n' +
                        '          </div>';
                }
                $("#store").html(html);
